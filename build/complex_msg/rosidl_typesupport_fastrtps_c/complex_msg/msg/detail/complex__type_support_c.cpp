...
#include "complex_msg/msg/detail/complex__rosidl_typesupport_fastrtps_c.h"
...
#include "complex_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Complex__ros_msg_type = complex_msg__msg__Complex;
  ...
  void * untyped_ros_message)
{
  ...
  _Complex__ros_msg_type * ros_message = static_cast<_Complex__ros_msg_type *>(untyped_ros_message);
  // Field name: real
  {
    cdr >> ros_message->real;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_complex_msg
size_t get_serialized_size_complex_msg__msg__Complex(
  const void * untyped_ros_message,
...
static uint32_t _Complex__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_complex_msg__msg__Complex(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_complex_msg
size_t max_serialized_size_complex_msg__msg__Complex(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Complex__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_complex_msg__msg__Complex(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, complex_msg, msg, Complex)() {
