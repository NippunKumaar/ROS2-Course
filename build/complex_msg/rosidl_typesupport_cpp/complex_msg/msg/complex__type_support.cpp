...
static const _Complex_type_support_symbol_names_t _Complex_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, complex_msg, msg, Complex)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, complex_msg, msg, Complex)),
  }
};
...
{
  return &::complex_msg::msg::rosidl_typesupport_cpp::Complex_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, complex_msg, msg, Complex)() {
  return get_message_type_support_handle<complex_msg::msg::Complex>();
}
