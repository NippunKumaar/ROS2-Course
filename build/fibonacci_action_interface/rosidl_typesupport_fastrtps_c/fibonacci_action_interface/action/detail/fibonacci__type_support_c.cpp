...
#include "fibonacci_action_interface/action/detail/fibonacci__rosidl_typesupport_fastrtps_c.h"
...
#include "fibonacci_action_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Fibonacci_Goal__ros_msg_type = fibonacci_action_interface__action__Fibonacci_Goal;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t get_serialized_size_fibonacci_action_interface__action__Fibonacci_Goal(
  const void * untyped_ros_message,
...
static uint32_t _Fibonacci_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fibonacci_action_interface__action__Fibonacci_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t max_serialized_size_fibonacci_action_interface__action__Fibonacci_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Fibonacci_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fibonacci_action_interface__action__Fibonacci_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_Goal)() {
...
using _Fibonacci_Result__ros_msg_type = fibonacci_action_interface__action__Fibonacci_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t get_serialized_size_fibonacci_action_interface__action__Fibonacci_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_Result__ros_msg_type * ros_message = static_cast<const _Fibonacci_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fibonacci_action_interface__action__Fibonacci_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t max_serialized_size_fibonacci_action_interface__action__Fibonacci_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Fibonacci_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fibonacci_action_interface__action__Fibonacci_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_Result)() {
...
using _Fibonacci_Feedback__ros_msg_type = fibonacci_action_interface__action__Fibonacci_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t get_serialized_size_fibonacci_action_interface__action__Fibonacci_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_Feedback__ros_msg_type * ros_message = static_cast<const _Fibonacci_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fibonacci_action_interface__action__Fibonacci_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t max_serialized_size_fibonacci_action_interface__action__Fibonacci_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Fibonacci_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fibonacci_action_interface__action__Fibonacci_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_Feedback)() {
...
// already included above
// #include "fibonacci_action_interface/action/detail/fibonacci__functions.h"  // goal
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_Goal)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_fibonacci_action_interface
...
using _Fibonacci_SendGoal_Request__ros_msg_type = fibonacci_action_interface__action__Fibonacci_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t get_serialized_size_fibonacci_action_interface__action__Fibonacci_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Fibonacci_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_fibonacci_action_interface__action__Fibonacci_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fibonacci_action_interface__action__Fibonacci_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t max_serialized_size_fibonacci_action_interface__action__Fibonacci_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_fibonacci_action_interface__action__Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Fibonacci_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fibonacci_action_interface__action__Fibonacci_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_SendGoal_Request)() {
...
using _Fibonacci_SendGoal_Response__ros_msg_type = fibonacci_action_interface__action__Fibonacci_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t get_serialized_size_fibonacci_action_interface__action__Fibonacci_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Fibonacci_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fibonacci_action_interface__action__Fibonacci_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t max_serialized_size_fibonacci_action_interface__action__Fibonacci_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Fibonacci_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fibonacci_action_interface__action__Fibonacci_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_SendGoal)() {
...
using _Fibonacci_GetResult_Request__ros_msg_type = fibonacci_action_interface__action__Fibonacci_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t get_serialized_size_fibonacci_action_interface__action__Fibonacci_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Fibonacci_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fibonacci_action_interface__action__Fibonacci_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t max_serialized_size_fibonacci_action_interface__action__Fibonacci_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Fibonacci_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fibonacci_action_interface__action__Fibonacci_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_GetResult_Request)() {
...
// already included above
// #include "fibonacci_action_interface/action/detail/fibonacci__functions.h"  // result
...
using _Fibonacci_GetResult_Response__ros_msg_type = fibonacci_action_interface__action__Fibonacci_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t get_serialized_size_fibonacci_action_interface__action__Fibonacci_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Fibonacci_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_fibonacci_action_interface__action__Fibonacci_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fibonacci_action_interface__action__Fibonacci_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t max_serialized_size_fibonacci_action_interface__action__Fibonacci_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_fibonacci_action_interface__action__Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Fibonacci_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fibonacci_action_interface__action__Fibonacci_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_GetResult)() {
...
// already included above
// #include "fibonacci_action_interface/action/detail/fibonacci__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Fibonacci_FeedbackMessage__ros_msg_type = fibonacci_action_interface__action__Fibonacci_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t get_serialized_size_fibonacci_action_interface__action__Fibonacci_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Fibonacci_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_fibonacci_action_interface__action__Fibonacci_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fibonacci_action_interface__action__Fibonacci_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fibonacci_action_interface
size_t max_serialized_size_fibonacci_action_interface__action__Fibonacci_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_fibonacci_action_interface__action__Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Fibonacci_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fibonacci_action_interface__action__Fibonacci_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fibonacci_action_interface, action, Fibonacci_FeedbackMessage)() {
