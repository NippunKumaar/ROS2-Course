...
#include "add_two_ints/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const add_two_ints::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<add_two_ints::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_add_two_ints
const rosidl_message_type_support_t *
get_message_type_support_handle<add_two_ints::srv::AddTwoInts_Request>()
{
  return &add_two_ints::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const add_two_ints::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<add_two_ints::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &add_two_ints::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &add_two_ints::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
