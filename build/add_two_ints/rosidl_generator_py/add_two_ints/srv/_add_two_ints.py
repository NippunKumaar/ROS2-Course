...
class Metaclass_AddTwoInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('add_two_ints')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from add_two_ints.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from add_two_ints.srv._add_two_ints import AddTwoInts_Request as Request
    from add_two_ints.srv._add_two_ints import AddTwoInts_Response as Response
