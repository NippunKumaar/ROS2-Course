...
#include "add_two_ints/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_c.h"
...
#include "add_two_ints/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _AddTwoInts_Request__ros_msg_type = add_two_ints__srv__AddTwoInts_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_add_two_ints
size_t get_serialized_size_add_two_ints__srv__AddTwoInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddTwoInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_add_two_ints__srv__AddTwoInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_add_two_ints
size_t max_serialized_size_add_two_ints__srv__AddTwoInts_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddTwoInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_add_two_ints__srv__AddTwoInts_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, add_two_ints, srv, AddTwoInts_Request)() {
...
using _AddTwoInts_Response__ros_msg_type = add_two_ints__srv__AddTwoInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_add_two_ints
size_t get_serialized_size_add_two_ints__srv__AddTwoInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddTwoInts_Response__ros_msg_type * ros_message = static_cast<const _AddTwoInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_add_two_ints__srv__AddTwoInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_add_two_ints
size_t max_serialized_size_add_two_ints__srv__AddTwoInts_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddTwoInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_add_two_ints__srv__AddTwoInts_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, add_two_ints, srv, AddTwoInts_Response)() {
...
// already included above
// #include "add_two_ints/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "add_two_ints/srv/add_two_ints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, add_two_ints, srv, AddTwoInts)() {
