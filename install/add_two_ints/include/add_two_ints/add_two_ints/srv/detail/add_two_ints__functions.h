...
#ifndef ADD_TWO_INTS__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
#define ADD_TWO_INTS__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
...
#include "add_two_ints/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_add_two_ints
bool
 ...
 * calls
 * add_two_ints__srv__AddTwoInts_Request__init().
...
/**
 * It calls
 * add_two_ints__srv__AddTwoInts_Request__fini()
 ...
 * add_two_ints__srv__AddTwoInts_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * add_two_ints__srv__AddTwoInts_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * add_two_ints__srv__AddTwoInts_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_add_two_ints
...
/**
 * It calls
 * add_two_ints__srv__AddTwoInts_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_add_two_ints
...
/**
 * It allocates the memory for the array and calls
 * add_two_ints__srv__AddTwoInts_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_add_two_ints
...
/**
 * It calls
 * add_two_ints__srv__AddTwoInts_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ADD_TWO_INTS__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
